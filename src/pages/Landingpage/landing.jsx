  ...
  return (
    <div data-new-gr-c-s-check-loaded="14.1096.0" data-gr-ext-installed="">
      <div id="__next" data-reactroot="">
        <header className={navbar ? 'fixed top-0 w-full z-30 bg-white transition-all shadow-md pt-0' : "fixed top-0 w-full z-30 bg-white transition-all pt-3"}>
          <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
            <div className="col-start-1 col-end-2 flex items-center">
              <strong>LOGO HERE</strong>
            </div>
            <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500 items-center">
              <a href="./" className="px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative text-green-500  animation-active active border-b-2 border-green-500">
                Home
              </a>
              <a href="./" className="px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative text-black-500 hover:text-green-500">
                Abortion Resources
              </a>
              <a href="./" className="px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative text-black-500 hover:text-green-500 ">
                Impact Model
        ...
        <nav className="fixed lg:hidden bottom-0 left-0 right-0 z-20 px-4 sm:px-8 shadow-t">
          <div className="bg-white-500 sm:px-3">
            <ul className="flex w-full justify-between items-center text-black-500">
              <a href="./" className="mx-1 sm:mx-2 px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all border-transparent">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
              ...
              <a href="./" className="mx-1 sm:mx-2 px-3 sm:px-4 py-2 flex flex-col items-center text-xs border-t-2 transition-all border-green-500 text-green-500 active">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
              ...
              <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2 gap-8 p y-8 my-12">
                ...
                <div>
                  <div className="flex opacity-1 transform-none flex-col items-end justify-center ml-auto w-full lg:w-9/12">
                    ...
                    <ul className="flex flex-col gap-1 text-black-500 self-start list-inside">
                      <li className="flex gap-3 opacity-1 transform-none circle-check custom-list">
                      ...
                      <li className="flex gap-3 circle-check custom-list opacity-1 transform-none">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12.1215 2.54932C6.60746 2.54932 2.12146 7.03532 2.12146 12.5493C2.12146 18.0633 6.60746 22.5493 12.1215 22.5493C17.6355 22.5493 22.1215 18.0633 22.1215 12.5493C22.1215 7.03532 17.6355 2.54932 12.1215 2.54932ZM10.1225 16.9623L7.11691 13.9632C6.72616 13.5733 6.72537 12.9405 7.11515 12.5496C7.50517 12.1585 8.13847 12.1578 8.52939 12.548L10.1205 14.1363L14.7075 9.54932C15.0979 9.15885 15.731 9.15885 16.1215 9.54932C16.5119 9.93978 16.5119 10.5729 16.1215 10.9633L10.1225 16.9623Z" fill="#2FAB73" />
                        </svg>
                        Her occupation
